...
# if __name__ == '__main__':
    ...
    # print(edge_start_new)
    # print(len(edge_start_new))
    # print('+'*20)
    # print(edge_end_new)
    # print(len(edge_end_new))
